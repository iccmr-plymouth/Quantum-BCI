...
# Online System
Primarily, there are two files for the online experiment, which actually controls the qubit using the BCI. The program adopts a client-server architecture. 'quantum_server.py' controls qubit and ''
